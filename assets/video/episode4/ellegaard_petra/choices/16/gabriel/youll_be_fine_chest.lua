...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/16/petra/youll_be_fine.pmp', buttons.r, true, 'assets/video/episode4/ellegaard_petra/choices/16/petra/youll_be_fine.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
