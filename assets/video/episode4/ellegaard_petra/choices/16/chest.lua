...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/16/chest.pmp', buttons.r, true, 'assets/video/episode4/ellegaard_petra/choices/16/chest.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.square) then
        ...
        choosing = false
        nextscene =  "assets/video/episode4/ellegaard_petra/choices/16/crafting_table.lua"
    elseif buttons.pressed(buttons.circle) then
        ...
        Image.unload(triangle)
        choosing = false
        nextscene =  "assets/video/episode4/ellegaard_petra/choices/16/bookcase_chest.lua"
	...
	Image.unload(square)
        ...
        Image.unload(triangle)
	choosing = false
	nextscene =  "assets/video/episode4/ellegaard_petra/choices/16/gabriel_chest.lua"
	...
	Image.unload(square)
        ...
        Image.unload(triangle)
	choosing = false
	nextscene =  "assets/video/episode4/ellegaard_petra/choices/16/redstone_hole_chest.lua"
