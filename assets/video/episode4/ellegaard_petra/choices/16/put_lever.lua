...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/16/put_lever.pmp', buttons.r, true, 'assets/video/episode4/ellegaard_petra/choices/16/put_lever.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    elseif buttons.pressed(buttons.circle) then
        ...
        choosing = false
        nextscene =  "assets/video/episode4/ellegaard_petra/choices/16/bookcase_putlever.lua"
	...
	choosing = false
	nextscene =  "assets/video/episode4/ellegaard_petra/choices/16/gabriel_putlever.lua"
