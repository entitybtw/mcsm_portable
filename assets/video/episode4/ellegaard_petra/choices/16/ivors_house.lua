...
local bg = Image.load("assets/video/episode4/ellegaard_petra/choices/16/ivors_house.png")
...
while in_interactive_zone do
	...
	if not bookcase_used then
		...
		intraFont.print(
			126 - intraFont.textW(font, choices_four.bookcase, 1.5) / 2 + 8,
			169 + 14,
	...
	if not chest_used then
		...
		intraFont.print(
			272 - intraFont.textW(font, choices_four.chest, 1.5) / 2 + 8,
			119 + 14,
			choices_four.chest,
			Color.new(255, 255, 255),
			font,
	...
	elseif chest_used and not crafting_table_used then
		...
		intraFont.print(
			289 - intraFont.textW(font, choices_four.crafting_table, 1.5) / 2 + 8,
			119 + 14,
	...
	if not redstone_hole_used and not crafting_table_used then
		...
		intraFont.print(
			397 - intraFont.textW(font, choices_four.redstone_hole, 1.5) / 2 + 8,
			147 + 14,
	...
	if not gabriel_talk then
		...
		intraFont.print(
			210 - intraFont.textW(font, choices_three.gabriel, 1.5) / 2 + 8,
			169 + 14,
	...
	if crafting_table_used and not put_lever then
		...
		intraFont.print(
			393 - intraFont.textW(font, choices_four.put_lever, 1.5) / 2 + 8,
			146 + 14,
	...
	elseif put_lever then
		Image.draw(spritesheet, 393, 146, 15, 15, nil, 414, 0, 15, 15)
		intraFont.print(
			393 - intraFont.textW(font, choices_four.lever, 1.5) / 2 + 8,
			146 + 14,
			choices_four.lever,
			Color.new(255, 255, 255),
			font,
	...
	intraFont.print(
		240 - intraFont.textW(font, ui.save, 0.63) / 2,
		230,
		ui.save,
	...
	while choosing do
		...
		if buttons.pressed(buttons.circle) then
			if not bookcase_used then
				playCutscene(
					"assets/video/episode4/ellegaard_petra/choices/16/bookcase.pmp",
					"assets/subtitles/episode4/ellegaard_petra/choices/16/bookcase.srt"
				)
				bookcase_used = true
				choosing = false
			end
		elseif buttons.pressed(buttons.square) then
			if not chest_used then
				playCutscene(
					"assets/video/episode4/ellegaard_petra/choices/16/chest.pmp",
					"assets/subtitles/episode4/ellegaard_petra/choices/16/chest.srt"
				)
				chest_used = true
				choosing = false
			elseif chest_used and not crafting_table_used then
				playCutscene(
					"assets/video/episode4/ellegaard_petra/choices/16/crafting_table.pmp",
					"assets/subtitles/episode4/ellegaard_petra/choices/16/crafting_table.srt"
				)
				crafting_table_used = true
				choosing = false
			elseif crafting_table_used and not put_lever then
				playCutscene(
					"assets/video/episode4/ellegaard_petra/choices/16/put_lever.pmp",
					"assets/subtitles/episode4/ellegaard_petra/choices/16/put_lever.srt"
				)
				put_lever = true
				choosing = false
			elseif put_lever then
		...
		elseif buttons.pressed(buttons.triangle) then
			if not redstone_hole_used and not crafting_table_used then
				playCutscene(
					"assets/video/episode4/ellegaard_petra/choices/16/redstone_hole.pmp",
					"assets/subtitles/episode4/ellegaard_petra/choices/16/redstone_hole.srt"
				)
		...
		elseif buttons.pressed(buttons.cross) then
			if not gabriel_talk then
				gabriel_talk = true
				choosing = false
				local gabriel = dofile("assets/video/episode4/ellegaard_petra/choices/16/gabriel.lua")
				if gabrielExitCode == 1 then
					goToMenu()
				end
			end
