...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/16/redstone_hole.pmp', buttons.r, true, 'assets/video/episode4/ellegaard_petra/choices/16/redstone_hole.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
