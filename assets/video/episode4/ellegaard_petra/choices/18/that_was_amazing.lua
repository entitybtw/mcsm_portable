...
local result = PMP.playExt('assets/video/episode4/ellegaard_petra/choices/18/that_was_amazing.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_petra/choices/18/that_was_amazing.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
