...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/6/use_the_amulet.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_petra/choices/6/use_the_amulet.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
