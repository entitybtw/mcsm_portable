...
local result = PMP.playExt('assets/video/episode4/ellegaard_petra/choices/6/let_it_chase_us.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_petra/choices/6/let_it_chase_us.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
