...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/12/we_have_to_continue.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_petra/choices/12/we_have_to_continue.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
