...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/23/you_coward_hoe.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_petra/choices/23/you_coward_hoe.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
