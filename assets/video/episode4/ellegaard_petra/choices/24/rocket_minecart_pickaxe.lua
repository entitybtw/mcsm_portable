...
local result = PMP.playEasy('assets/video/episode4/ellegaard_petra/choices/24/rocket_minecart_pickaxe.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_petra/choices/24/rocket_minecart_pickaxe.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
