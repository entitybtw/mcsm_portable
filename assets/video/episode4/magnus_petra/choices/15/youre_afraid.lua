...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/15/youre_afraid.pmp', buttons.r, true, 'assets/video/episode4/magnus_petra/choices/15/youre_afraid.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
	...
	Image.unload(square)
        ...
        Image.unload(triangle)
	choosing = false
	nextscene =  "assets/video/episode4/magnus_petra/choices/16/gabriel.lua"
