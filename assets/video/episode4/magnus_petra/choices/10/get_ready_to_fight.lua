...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/10/get_ready_to_fight.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_petra/choices/10/get_ready_to_fight.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
