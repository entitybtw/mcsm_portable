...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/10/ill_distract_them.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_petra/choices/10/ill_distract_them.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
