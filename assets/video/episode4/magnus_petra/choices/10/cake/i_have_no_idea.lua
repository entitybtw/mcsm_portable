...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/10/cake/i_have_no_idea.pmp', buttons.r, true, 'assets/video/episode4/magnus_petra/choices/10/cake/i_have_no_idea.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
