...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/16/crafting_table.pmp', buttons.r, true, 'assets/video/episode4/magnus_petra/choices/16/crafting_table.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    elseif buttons.pressed(buttons.circle) then
        ...
        choosing = false
        nextscene =  "assets/video/episode4/magnus_petra/choices/16/bookcase_craftingtable.lua"
	...
	choosing = false
	nextscene =  "assets/video/episode4/magnus_petra/choices/16/gabriel_craftingtable.lua"
