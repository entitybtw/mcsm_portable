...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/27/im_here_for_you_boy.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_petra/choices/27/im_here_for_you_boy.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
