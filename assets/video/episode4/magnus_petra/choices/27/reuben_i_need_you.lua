...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/27/reuben_i_need_you.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_petra/choices/27/reuben_i_need_you.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
