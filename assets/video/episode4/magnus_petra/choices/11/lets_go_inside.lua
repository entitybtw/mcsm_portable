...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/11/lets_go_inside.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_petra/choices/11/lets_go_inside.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
