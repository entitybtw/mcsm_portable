...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/16/bookcase.pmp', buttons.r, true, 'assets/video/episode4/magnus_gabriel/choices/15/bookcase.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
