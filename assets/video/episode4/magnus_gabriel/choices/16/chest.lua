...
PMP.playEasy('assets/video/episode4/magnus_petra/choices/16/chest.pmp', buttons.r, true, 'assets/video/episode4/magnus_petra/choices/16/chest.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
...
while choosing do
	...
	Image.unload(square)
        ...
        Image.unload(triangle)
	choosing = false
	nextscene =  "assets/video/episode4/magnus_petra/choices/16/petra_chest.lua"
