...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/16/petra/i_wont_lie_to_you.pmp', buttons.r, true, 'assets/video/episode4/magnus_gabriel/choices/16/petra/i_wont_lie_to_you.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    elseif buttons.pressed(buttons.circle) then
        ...
        Image.unload(triangle)
        choosing = false
        nextscene =  "assets/video/episode4/magnus_gabriel/choices/16/bookcase.lua"
