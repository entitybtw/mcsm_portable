...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/3/gabriel/we_all_make_mistakes.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_gabriel/choices/3/gabriel/we_all_make_mistakes.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
