...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/3/gabriel/doesnt_matter_now.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_gabriel/choices/3/gabriel/doesnt_matter_now.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
