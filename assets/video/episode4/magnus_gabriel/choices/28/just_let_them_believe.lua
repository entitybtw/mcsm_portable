...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/28/just_let_them_believe.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_gabriel/choices/28/just_let_them_believe.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
