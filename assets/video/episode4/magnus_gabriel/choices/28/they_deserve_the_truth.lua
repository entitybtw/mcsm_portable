...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/28/they_deserve_the_truth.pmp', buttons.r, true, 'assets/video/episode4/magnus_gabriel/choices/28/they_deserve_the_truth.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
