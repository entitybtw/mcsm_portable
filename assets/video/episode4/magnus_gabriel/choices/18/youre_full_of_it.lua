...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/18/youre_full_of_it.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_gabriel/choices/18/youre_full_of_it.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
