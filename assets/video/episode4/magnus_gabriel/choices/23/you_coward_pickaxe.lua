...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/23/you_coward_pickaxe.pmp', buttons.r, true, 'assets/video/episode4/magnus_gabriel/choices/23/you_coward_pickaxe.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
