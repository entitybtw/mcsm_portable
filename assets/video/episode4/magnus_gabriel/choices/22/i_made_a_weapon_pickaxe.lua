...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/22/i_made_a_weapon_pickaxe.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_gabriel/choices/22/i_made_a_weapon_pickaxe.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
