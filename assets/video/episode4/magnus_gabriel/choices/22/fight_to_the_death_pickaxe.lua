...
local result = PMP.playExt('assets/video/episode4/magnus_gabriel/choices/22/fight_to_the_death_pickaxe.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_gabriel/choices/22/fight_to_the_death_pickaxe.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
