...
local result = PMP.playEasy('assets/video/episode4/magnus_gabriel/choices/9/we_need_that_cake.pmp', buttons.r, true, 'assets/subtitles/episode4/magnus_gabriel/choices/9/we_need_that_cake.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
