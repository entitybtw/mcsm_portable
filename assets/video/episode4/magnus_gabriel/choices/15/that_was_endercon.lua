...
local result = PMP.playEasy('assets/video/episode4/magnus_petra/choices/15/that_was_endercon.pmp', buttons.r, true, 'assets/video/episode4/magnus_petra/choices/15/that_was_endercon.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
