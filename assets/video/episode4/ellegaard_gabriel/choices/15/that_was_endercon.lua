...
local result = PMP.playEasy('assets/video/episode4/ellegaard_gabriel/choices/15/that_was_endercon.pmp', buttons.r, true, 'assets/video/episode4/ellegaard_gabriel/choices/15/that_was_endercon.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.square) then
        ...
        choosing = false
        nextscene =  "assets/video/episode4/ellegaard_gabriel/choices/16/chest.lua"
	...
	Image.unload(square)
        ...
        Image.unload(triangle)
	choosing = false
	nextscene =  "assets/video/episode4/ellegaard_gabriel/choices/16/redstone_hole.lua"
