...
local result = PMP.playEasy('assets/video/episode4/ellegaard_gabriel/choices/5/the_world_needs_us_reuben.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_gabriel/choices/5/the_world_needs_us_reuben.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
