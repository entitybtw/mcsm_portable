...
local result = PMP.playExt(
	"assets/video/episode4/ellegaard_gabriel/choices/5/the_world_needs_us_reuben.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode4/ellegaard_gabriel/choices/5/the_world_needs_us_reuben.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
