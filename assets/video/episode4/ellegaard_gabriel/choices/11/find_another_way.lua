...
local result = PMP.playEasy('assets/video/episode4/ellegaard_gabriel/choices/11/find_another_way.pmp', buttons.r, true, 'assets/video/episode4/ellegaard_gabriel/choices/11/find_another_way.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
