...
local result = PMP.playEasy('assets/video/episode4/ellegaard_gabriel/choices/23/come_back_hoe.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_gabriel/choices/23/come_back_hoe.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
