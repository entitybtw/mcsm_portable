...
local result = PMP.playExt('assets/video/episode4/ellegaard_gabriel/choices/16/lever.pmp', buttons.r, true, 'assets/subtitles/episode4/ellegaard_gabriel/choices/16/lever.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
