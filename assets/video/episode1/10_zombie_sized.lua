...
local result = PMP.playEasy('assets/video/episode1/10_zombie_sized.pmp', buttons.r, true, "assets/subtitles/episode1/10_zombie_sized.srt", font, 0.4, "#FFFFFF", "#000000/150")
if result == 1 then
