...
local result = PMP.playEasy('assets/video/episode1/100_chicken_sized.pmp', buttons.r, true, "assets/subtitles/episode1/100_chicken_sized.srt", font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
