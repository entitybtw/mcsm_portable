...
local choices = {
	{
		...
		rightchoice = choices_one.ten_zombie_sized,
...

	{
		id = "choice1",
		path = ep1,
		leftchoice = choices_one.cool_mask,
		rightchoice = choices_one.not_funny_axel,
...

	{
		id = "choice5",
		path = ep1 .. "choices/3/",
		leftchoice = choices_one.may_the_best_team_win,
...

	{
		id = "choice7",
		path = ep1 .. "choices/5/",
		leftchoice = choices_one.run_i_distract_them,
		rightchoice = choices_one.stay_close_i_protect_you,
...
while currentchoice do
	...
	if currentchoice.leftchoice or currentchoice.rightchoice or currentchoice.middlechoice then
		...
		if currentchoice.rightchoice then
			intraFont.print(
				450 - intraFont.textW(font, currentchoice.rightchoice, 0.4),
				127,
				currentchoice.rightchoice,
		...
		intraFont.print(
			340 - intraFont.textW(font, ui.save, 0.63),
			230,
			ui.save,
