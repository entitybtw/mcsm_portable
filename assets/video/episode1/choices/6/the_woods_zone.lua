...
while in_interactive_zone do
	...
	while choosing do
		...
		if buttons.pressed(buttons.cross) then
			if not smoke_trail_used then
				playCutscene(
					"assets/video/episode1/choices/6/smoke_trail.pmp",
					"assets/subtitles/episode1/choices/6/smoke_trail.srt"
				)
			...
			elseif smoke_trail_used then
				...
				local result = PMP.playExt(
					"assets/video/episode1/choices/6/tall_grass.pmp",
					buttons.r,
					true,
					"assets/subtitles/episode1/choices/6/tall_grass.srt",
					font,
					subssize,
					"#FFFFFF",
					"#000000/110",
		...
		elseif buttons.pressed(buttons.circle) then
			if not water_well_used then
				playCutscene(
					"assets/video/episode1/choices/6/water_well.pmp",
					"assets/subtitles/episode1/choices/6/water_well.srt"
				)
