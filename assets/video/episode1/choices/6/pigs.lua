...
local result = PMP.playEasy('assets/video/episode1/choices/6/pigs.pmp', buttons.r, true, 'assets/video/episode1/choices/6/pigs.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
