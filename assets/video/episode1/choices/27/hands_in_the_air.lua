...
local result = PMP.playExt(
	"assets/video/episode1/choices/27/hands_in_the_air.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode1/choices/27/hands_in_the_air.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_one.it_was_fine, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_one.yeah_its_awful, 2),
	127,
