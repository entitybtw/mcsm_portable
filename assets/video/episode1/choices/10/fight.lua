...
local result = PMP.playEasy('assets/video/episode1/choices/10/fight_' .. building .. '_' .. reuben .. '.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/10/fight_' .. building .. '_' .. reuben .. '.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
