...
local result = PMP.playExt(
	"assets/video/episode1/choices/23/follow_gabriel.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode1/choices/23/follow_gabriel.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_one.but_why_me, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_one.where_are_they, 2),
	127,
