...
local result = PMP.playExt(
	"assets/video/episode1/choices/28/it_was_fine.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode1/choices/28/it_was_fine.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_one.i_go_first, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_one.you_can_do_it, 2),
	127,
