...
local result = PMP.playExt(
	"assets/video/episode1/choices/7/run_i_distract_them.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode1/choices/7/run_i_distract_them.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_one.im_all_in, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_one.whats_in_it_for_me, 2),
	127,
