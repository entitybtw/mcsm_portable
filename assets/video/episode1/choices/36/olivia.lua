...
local result =     PMP.playEasy('assets/video/episode1/choices/36/olivia.pmp', buttons.r, true, 'assets/video/episode1/choices/36/olivia.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
elseif pedestal == "on" then
    PMP.setVolume(pmpvolume)
local result =     PMP.playEasy('assets/video/episode1/choices/36/olivia_pedestal.pmp', buttons.r, true, 'assets/video/episode1/choices/36/olivia_pedestal.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
    nextscene = "./mainmenu.lua"
    return 1
end
