...
if pedestal == "off" then
    ...
    PMP.playEasy('assets/video/episode1/choices/36/olivia.pmp', buttons.r, true, 'assets/video/episode1/choices/36/olivia.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
...
elseif pedestal == "on" then
    PMP.setVolume(pmpvolume)
    PMP.playEasy('assets/video/episode1/choices/36/olivia_pedestal.pmp', buttons.r, true, 'assets/video/episode1/choices/36/olivia_pedestal.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
