...
local result =     PMP.playEasy('assets/video/episode1/choices/36/axel.pmp', buttons.r, true, 'assets/video/episode1/choices/36/axel.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
