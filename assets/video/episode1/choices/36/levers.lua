...
local result = PMP.playEasy('assets/video/episode1/choices/36/levers.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/36/levers.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
