...
while in_interactive_zone do
	...
	if not olivia_talk then
		...
		intraFont.print(
			305 - intraFont.textW(font, choices_one.olivia, 1.5) / 2 + 8,
			157 + 14,
			choices_one.olivia,
	...
	if not axel_talk then
		...
		intraFont.print(
			123 - intraFont.textW(font, choices_one.axel, 1.5) / 2 + 8,
			161 + 14,
			choices_one.axel,
			Color.new(255, 255, 255),
			font,
	...
	if not lukas_talk then
		...
		intraFont.print(
			174 - intraFont.textW(font, choices_one.lukas, 1.5) / 2 + 8,
			153 + 14,
			choices_one.lukas,
			Color.new(255, 255, 255),
			font,
	...
	if not pedestal_used then
		...
		intraFont.print(
			243 - intraFont.textW(font, choices_one.pedestal, 1.5) / 2 + 8,
			139 + 14,
	...
	elseif pedestal_used then
		...
		intraFont.print(
			392 - intraFont.textW(font, choices_one.levers, 1.5) / 2 + 8,
			183 + 14,
			choices_one.levers,
			Color.new(255, 255, 255),
			font,
