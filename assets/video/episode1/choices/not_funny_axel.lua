...
local result = PMP.playExt('assets/video/episode1/choices/not_funny_axel.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/not_funny_axel.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
