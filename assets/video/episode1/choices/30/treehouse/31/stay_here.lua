...
local result = PMP.playEasy('assets/video/episode1/choices/30/treehouse/31/stay_here.pmp', buttons.r, true, 'assets/video/episode1/choices/30/treehouse/31/stay_here.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
