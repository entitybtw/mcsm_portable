...
local result = PMP.playExt(
	"assets/video/episode1/choices/30/treehouse/31/stay_here.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode1/choices/30/treehouse/31/stay_here.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_one.craft_a_bow, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_one.craft_a_fishing_pole, 2),
	127,
