...
local result = PMP.playEasy('assets/video/episode1/choices/33/keep_your_distance.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/33/keep_your_distance.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
