...
local result = PMP.playEasy('assets/video/episode1/choices/33/all_is_good.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/33/all_is_good.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
