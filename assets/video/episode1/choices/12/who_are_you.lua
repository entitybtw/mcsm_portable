...
local result = PMP.playExt('assets/video/episode1/choices/12/who_are_you_' .. reuben .. '.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/12/who_are_you_' .. reuben .. '.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
