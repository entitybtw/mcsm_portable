...
local result = PMP.playExt(
	"assets/video/episode1/choices/24/where_are_they.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode1/choices/24/where_are_they.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_one.save_gabriel, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_one.save_petra, 2),
	127,
