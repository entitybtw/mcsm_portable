...
local result = PMP.playExt('assets/video/episode1/choices/24/but_why_me.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/24/but_why_me.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
