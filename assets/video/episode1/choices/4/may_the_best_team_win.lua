...
local result = PMP.playEasy('assets/video/episode1/choices/4/may_the_best_team_win.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/4/may_the_best_team_win.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
