...
local result = PMP.playEasy('assets/video/episode1/choices/4/we_going_to_crush_you.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/4/we_going_to_crush_you.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
