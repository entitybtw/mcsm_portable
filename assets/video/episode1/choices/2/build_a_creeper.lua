...
local result = PMP.playExt('assets/video/episode1/choices/2/build_a_creeper.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/2/build_a_creeper.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
intraFont.print(450 - intraFont.textW(font, choices_one.nether_maniacs, 0.4), 127, choices_one.nether_maniacs, Color.new(255,255,255), font, 0.4)
