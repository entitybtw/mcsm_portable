...
local result = PMP.playExt('assets/video/episode1/choices/2/build_a_enderman.pmp', buttons.r, true, 'assets/subtitles/episode1/choices/2/build_a_enderman.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
