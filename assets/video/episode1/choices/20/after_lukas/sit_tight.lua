...
local result = PMP.playExt(
	"assets/video/episode1/choices/20/after_lukas/sit_tight.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode1/choices/20/after_lukas/sit_tight.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_one.somebody_stop_him, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_one.this_cant_be_good, 2),
	127,
