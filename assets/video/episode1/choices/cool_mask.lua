...
PMP.playEasy('assets/video/episode1/choices/cool_mask.pmp', buttons.r, true, 'assets/video/episode1/choices/cool_mask.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
