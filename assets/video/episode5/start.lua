...
intraFont.print(25 + 15 + 5, 127, "For glory!", Color.new(255,255,255), font, 0.4)
intraFont.print(455 - 5 - intraFont.textW(font, "Let's find treasure!", 0.4), 127, "Let's find treasure!", Color.new(255,255,255), font, 0.4)
