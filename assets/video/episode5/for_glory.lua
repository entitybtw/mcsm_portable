...
local result = PMP.playExt(
	"assets/video/episode5/for_glory.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode5/for_glory.srt",
	font,
	subssize,
	"#FFFFFF",
	"#000000/150",
...
intraFont.print(45, 127, choices_five.i_was_clueless, Color.new(255, 255, 255), font, 0.4)
intraFont.print(
	450 - intraFont.textW(font, choices_five.weve_come_so_far, 0.4),
	127,
	choices_five.weve_come_so_far,
