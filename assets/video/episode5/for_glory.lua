...
local result = PMP.playExt('assets/video/episode5/for_glory.pmp', buttons.r, true, 'assets/subtitles/episode5/for_glory.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
