...
local result = PMP.playEasy('assets/video/episode5/choices/5/dont_mess_with_me.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/5/dont_mess_with_me.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
