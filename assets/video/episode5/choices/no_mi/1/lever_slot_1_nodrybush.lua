...
while choosing do
    ...
    if buttons.pressed(buttons.triangle) then
        ...
        Image.unload(square)
        choosing = false
        nextscene = "assets/video/episode5/choices/no_mi/1/cobblestone_noleverslot_nodrybush.lua"
    elseif buttons.pressed(buttons.square) then
        Image.unload(triangle)
        Image.unload(square)
        choosing = false1
        nextscene = "assets/video/episode5/choices/no_mi/1/bookcase_noleverslot_nodrybush.lua"
