...
while choosing do
    ...
    if buttons.pressed(buttons.circle) then
        ...
        Image.unload(square)
        choosing = false
        if mi == "ivor" then nextscene = "assets/video/episode5/choices/no_mi/1/supply_door_nodrybush.lua" else nextscene = "assets/video/episode5/choices/no_mi/1/strange_wall_nodrybush.lua" end
