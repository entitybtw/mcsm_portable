...
while choosing do
    ...
    if buttons.pressed(buttons.square) then
        ...
        Image.unload(cross)
        choosing = false
        nextscene = "assets/video/episode5/choices/no_mi/1/bookcase_noleverslot_nocobblestone.lua"
    elseif buttons.pressed(buttons.cross) then
        Image.unload(square)
        Image.unload(cross)
        choosing = false
        nextscene = "assets/video/episode5/choices/no_mi/1/drybush_noleverslot_nocobblestone.lua"
