...
while choosing do
    ...
    if buttons.pressed(buttons.circle) then
        ...
        Image.unload(cross)
        choosing = false
        nextscene = "assets/video/episode5/choices/no_mi/1/lever_slot_1_nobookcase_nodrybush.lua"
    elseif buttons.pressed(buttons.cross) then
        Image.unload(circle)
        Image.unload(cross)
        choosing = false
        nextscene = "assets/video/episode5/choices/no_mi/1/crafting_table_nodoor_nobookcase_nodrybush.lua"
