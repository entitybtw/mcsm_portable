...
while choosing do
    ...
    if buttons.pressed(buttons.triangle) then
        ...
        Image.unload(cross)
        choosing = false
        nextscene = "assets/video/episode5/choices/no_mi/1/cobblestone_noleverslot_nobookcase.lua"
    elseif buttons.pressed(buttons.cross) then
        Image.unload(triangle)
        Image.unload(cross)
        choosing = false
        nextscene = "assets/video/episode5/choices/no_mi/1/drybush_noleverslot_nobookcase.lua"
