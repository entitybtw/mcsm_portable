...
local result = PMP.playEasy('assets/video/episode5/choices/19/ivor/you_just_want_power.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/19/ivor/you_just_want_power.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
