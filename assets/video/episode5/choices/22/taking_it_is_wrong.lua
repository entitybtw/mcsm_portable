...
local result = PMP.playExt('assets/video/episode5/choices/22/taking_it_is_wrong.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/22/taking_it_is_wrong.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
