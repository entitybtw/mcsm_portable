...
local result = PMP.playEasy('assets/video/episode5/choices/22/aiden_cant_get_it.pmp', buttons.r, true, 'assets/video/episode5/choices/22/aiden_cant_get_it.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
