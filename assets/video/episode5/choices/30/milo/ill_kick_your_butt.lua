...
local result = PMP.playEasy('assets/video/episode5/choices/30/milo/ill_kick_your_butt.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/30/milo/ill_kick_your_butt.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
