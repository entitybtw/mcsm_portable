...
local result = PMP.playEasy('assets/video/episode5/choices/30/milo/give_up_aiden.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/30/milo/give_up_aiden.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
