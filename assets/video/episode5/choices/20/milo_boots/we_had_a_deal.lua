...
local result = PMP.playEasy('assets/video/episode5/choices/20/milo_boots/we_had_a_deal.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/20/milo_boots/we_had_deal.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
