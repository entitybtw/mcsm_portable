...
local result = PMP.playEasy('assets/video/episode5/choices/20/milo_boots/ill_do_it_for_my_friends.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/20/milo_boots/ill_do_it_for_my_friends.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
