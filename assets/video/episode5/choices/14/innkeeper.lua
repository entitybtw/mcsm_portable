...
local result = PMP.playEasy('assets/video/episode5/choices/14/innkeeper.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/14/innkeeper.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
