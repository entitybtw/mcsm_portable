...
local result = PMP.playEasy('assets/video/episode5/choices/14/crafting_table.pmp', buttons.r, true, 'assets/video/episode5/choices/14/crafting_table.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
