...
intraFont.print(450 - intraFont.textW(font, choices_fifth.your_secrets_safe_with_me, 0.4), 127, choices_fifth.your_secrets_safe_with_me, Color.new(255,255,255), font, 0.4)
