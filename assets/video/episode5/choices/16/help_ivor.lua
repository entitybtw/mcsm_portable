...
intraFont.print(45, 127, choices_five.shut_up_both_of_you, Color.new(255, 255, 255), font, 0.4)
intraFont.print(
	450 - intraFont.textW(font, choices_five.yeah_aidens_our_focus, 0.4),
	127,
	choices_five.yeah_aidens_our_focus,
