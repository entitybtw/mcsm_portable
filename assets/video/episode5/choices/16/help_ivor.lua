...
local result = PMP.playExt('assets/video/episode5/choices/16/help_ivor.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/16/help_ivor.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
