...
local result = PMP.playEasy('assets/video/episode5/choices/18/ivor/he_stole_from_us.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/18/ivor/he_stole_from_us.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
