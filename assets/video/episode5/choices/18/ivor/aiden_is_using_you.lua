...
local result = PMP.playExt(
	"assets/video/episode5/choices/18/ivor/aiden_is_using_you.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode5/choices/18/ivor/aiden_is_using_you.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_five.we_can_help_you, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_five.you_just_want_power, 2),
	127,
