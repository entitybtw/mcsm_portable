...
local result = PMP.playEasy('assets/video/episode5/choices/18/ivor/aiden_is_using_you.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/18/ivor/aiden_is_using_you.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
