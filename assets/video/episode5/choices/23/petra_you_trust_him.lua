...
local result = PMP.playEasy('assets/video/episode5/choices/23/petra_you_trust_him.pmp', buttons.r, true, 'assets/video/episode5/choices/23/petra_you_trust_him.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
