...
local result = PMP.playEasy('assets/video/episode5/choices/3/redstone_rap.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/3/redstone_rap.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
