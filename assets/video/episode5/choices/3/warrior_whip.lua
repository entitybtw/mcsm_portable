...
local result = PMP.playEasy('assets/video/episode5/choices/3/warrior_whip.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/3/warrior_whip.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
