...
local result = PMP.playEasy('assets/video/episode5/choices/17/ivor/shut_up_both_of_you.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/17/ivor/shut_up_both_of_you.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
