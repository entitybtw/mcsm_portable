...
local result = PMP.playExt('assets/video/episode5/choices/17/ivor/yeah_aidens_our_focus.pmp', buttons.r, true, 'assets/subtitles/episode5/choices/17/ivor/yeah_aidens_our_focus.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
