...
local result = PMP.playEasy('assets/video/episode5/choices/15/dont_lie_to_me.pmp', buttons.r, true, 'assets/video/episode5/choices/15/dont_lie_to_me.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
