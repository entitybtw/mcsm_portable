...
intraFont.print(455 - 5 - intraFont.textW(font, "Go with Milk", 0.4), 127, "Go with Milk", Color.new(255,255,255), font, 0.4)
...
while choosing do
    ...
    elseif buttons.pressed(buttons.circle) then
        ...
        Image.unload(circle)
        choosing = false
        nextscene = "assets/video/episode5/choices/16/go_with_milk.lua"
