...
local result = PMP.playExt('assets/video/episode5/lets_find_treasure.pmp', buttons.r, true, 'assets/subtitles/episode5/lets_find_treasure.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
