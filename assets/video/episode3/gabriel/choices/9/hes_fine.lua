...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/9/hes_fine.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/9/hes_fine.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
