...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/9/gabriel_is_sick/you_can_do_this.pmp', buttons.r, true, 'assets/video/episode3/gabriel/choices/9/gabriel_is_sick/you_can_do_this.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
