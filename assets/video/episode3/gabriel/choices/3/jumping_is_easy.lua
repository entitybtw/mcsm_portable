...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/3/jumping_is_easy.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/3/jumping_is_easy.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
