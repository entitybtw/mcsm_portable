...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/3/tuck_and_roll.pmp', buttons.r, true, 'assets/video/episode3/gabriel/choices/3/tuck_and_roll.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
