local choosing = true
local img = Image.load('assets/video/episode3/gabriel/choices/15/that_was_cool.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/gabriel/choices/15/that_was_cool.pmp', buttons.r)
