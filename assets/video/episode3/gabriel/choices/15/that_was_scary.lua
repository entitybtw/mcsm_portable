local choosing = true
local img = Image.load('assets/video/episode3/gabriel/choices/15/that_was_scary.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/gabriel/choices/15/that_was_scary.pmp', buttons.r)
