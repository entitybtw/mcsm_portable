local choosing = true
local img = Image.load('assets/video/episode3/gabriel/choices/7/im_hallucinating.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/gabriel/choices/7/im_hallucinating.pmp', buttons.r)
