...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/14/eyes_down.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/14/eyes_down.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
