...
local result = PMP.playExt(
	"assets/video/episode3/gabriel/choices/6/follow_lukas.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode3/gabriel/choices/6/follow_lukas.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_three.its_beautiful, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_three.im_hallucinating, 2),
	127,
