...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/8/gabriel.pmp', buttons.r, true, 'assets/video/episode3/gabriel/choices/8/gabriel.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.square) then
        ...
        Image.unload(cross)
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/8/levergabriel.lua"
    elseif buttons.pressed(buttons.circle) then
        Image.unload(square)
        Image.unload(circle)
        Image.unload(cross)
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/8/reuben_nogabriel.lua"
    elseif buttons.pressed(buttons.cross) then
        Image.unload(square)
        Image.unload(circle)
        Image.unload(cross)
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/8/fountain_nogabriel.lua"
