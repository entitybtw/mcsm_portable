local choosing = true
local img = Image.load('assets/video/episode3/gabriel/choices/4/save_amulet.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/gabriel/choices/4/save_amulet.pmp', buttons.r)
