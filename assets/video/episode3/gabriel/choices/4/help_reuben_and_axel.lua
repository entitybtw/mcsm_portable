...
local result = PMP.playExt('assets/video/episode3/gabriel/choices/4/help_reuben_and_axel.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/4/help_reuben_and_axel.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
intraFont.print(450 - intraFont.textW(font, choices_three.thanks_for_grabbing_it, 0.4), 127, choices_three.thanks_for_grabbing_it, Color.new(255,255,255), font, 0.4)
