...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/4/save_amulet/dont_touch_my_pig.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/4/save_amulet/dont_touch_my_pig.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
