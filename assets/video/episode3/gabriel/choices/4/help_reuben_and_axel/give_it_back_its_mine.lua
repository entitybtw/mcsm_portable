...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/4/help_reuben_and_axel/give_it_back_its_mine.pmp', buttons.r, true, 'assets/video/episode3/gabriel/choices/4/help_reuben_and_axel/give_it_back_its_mine.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
