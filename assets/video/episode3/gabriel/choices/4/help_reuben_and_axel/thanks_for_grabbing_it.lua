...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/4/help_reuben_and_axel/thanks_for_grabbing_it.pmp', buttons.r, true, 'assets/video/episode3/gabriel/choices/4/help_reuben_and_axel/thanks_for_grabbing_it.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
