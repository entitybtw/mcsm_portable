...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/16/button.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/16/button.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.cross) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/lukas2_noolivia.lua"
    elseif buttons.pressed(buttons.square) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/chest.lua"
    elseif buttons.pressed(buttons.circle) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/axel2_noolivia.lua"
