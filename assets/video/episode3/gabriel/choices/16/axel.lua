...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/16/axel.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/16/axel.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.square) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/button_noaxel.lua"
    elseif buttons.pressed(buttons.cross) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/lukas_noaxel.lua"
    elseif buttons.pressed(buttons.triangle) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/olivia_noaxel.lua"
