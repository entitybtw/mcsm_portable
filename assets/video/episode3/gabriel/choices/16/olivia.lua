...
local result = PMP.playEasy('assets/video/episode3/gabriel/choices/16/olivia.pmp', buttons.r, true, 'assets/subtitles/episode3/gabriel/choices/16/olivia.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.square) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/button_noolivia.lua"
    elseif buttons.pressed(buttons.circle) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/axel_noolivia.lua"
    elseif buttons.pressed(buttons.cross) then
        choosing = false
        nextscene =  "assets/video/episode3/gabriel/choices/16/lukas_noolivia.lua"
