...
local result = PMP.playExt(
	"assets/video/episode3/gabriel/we_have_to_tell_the_others.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode3/gabriel/we_have_to_tell_the_others.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_three.drop_amulet, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_three.jump_down, 2),
	127,
