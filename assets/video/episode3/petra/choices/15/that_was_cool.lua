...
local result = PMP.playEasy('assets/video/episode3/petra/choices/15/that_was_cool.pmp', buttons.r, true, 'assets/video/episode3/petra/choices/15/that_was_cool.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
