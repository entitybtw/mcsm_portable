...
local result = PMP.playEasy('assets/video/episode3/petra/choices/15/that_was_scary.pmp', buttons.r, true, 'assets/video/episode3/petra/choices/15/that_was_scary.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
>>>>>>> 75d0b7e (little refactor choices text displaying)
