local choosing = true
local img = Image.load('assets/video/episode3/petra/choices/4/help_reuben_and_axel.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/petra/choices/4/help_reuben_and_axel.pmp', buttons.r)
