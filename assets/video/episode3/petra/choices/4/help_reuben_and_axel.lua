...
local result = PMP.playExt('assets/video/episode3/petra/choices/4/help_reuben_and_axel.pmp', buttons.r, true, 'assets/subtitles/episode3/petra/choices/4/help_reuben_and_axel.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
