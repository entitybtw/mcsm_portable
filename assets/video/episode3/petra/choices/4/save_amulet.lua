...
local result = PMP.playEasy('assets/video/episode3/petra/choices/4/save_amulet.pmp', buttons.r, true, 'assets/subtitles/episode3/petra/choices/4/save_amulet.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
