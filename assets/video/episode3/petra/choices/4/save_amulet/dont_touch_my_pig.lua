...
local result = PMP.playEasy('assets/video/episode3/petra/choices/4/save_amulet/dont_touch_my_pig.pmp', buttons.r, true, 'assets/video/episode3/petra/choices/4/save_amulet/dont_touch_my_pig.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
