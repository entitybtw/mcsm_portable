...
local result = PMP.playEasy('assets/video/episode3/petra/choices/4/save_amulet/thanks_for_saving_reuben.pmp', buttons.r, true, 'assets/video/episode3/petra/choices/4/save_amulet/thanks_for_saving_reuben.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
