local choosing = true
local img = Image.load('assets/video/episode3/petra/choices/7/its_beautiful.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/petra/choices/7/its_beautiful.pmp', buttons.r)
