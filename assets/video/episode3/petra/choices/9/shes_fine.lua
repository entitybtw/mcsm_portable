...
local result = PMP.playEasy('assets/video/episode3/petra/choices/9/shes_fine.pmp', buttons.r, true, 'assets/video/episode3/petra/choices/9/shes_fine.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
