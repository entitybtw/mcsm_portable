local choosing = true
local img = Image.load('assets/video/episode3/petra/choices/9/petra_is_sick.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/petra/choices/9/petra_is_sick.pmp', buttons.r)
