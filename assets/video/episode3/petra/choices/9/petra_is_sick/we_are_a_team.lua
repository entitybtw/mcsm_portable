...
local result = PMP.playEasy('assets/video/episode3/petra/choices/9/petra_is_sick/we_are_a_team.pmp', buttons.r, true, 'assets/video/episode3/petra/choices/9/petra_is_sick/we_are_a_team.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
