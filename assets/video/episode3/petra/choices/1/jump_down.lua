...
local result = PMP.playExt('assets/video/episode3/petra/choices/1/jump_down.pmp', buttons.r, true, 'assets/subtitles/episode3/petra/choices/1/jump_down.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
