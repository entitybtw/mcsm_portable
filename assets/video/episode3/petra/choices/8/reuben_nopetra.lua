...
local result = PMP.playEasy('assets/video/episode3/petra/choices/8/reuben.pmp', buttons.r, true, 'assets/video/episode3/petra/choices/8/reuben.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.circle) then
        ...
        Image.unload(cross)
        choosing = false
        nextscene =  "assets/video/episode3/petra/choices/8/leverreuben_nopetra.lua"
    elseif buttons.pressed(buttons.cross) then
        Image.unload(square)
        Image.unload(circle)
        Image.unload(cross)
        choosing = false
        nextscene =  "assets/video/episode3/petra/choices/8/fountain_nopetra_noreuben.lua"
    elseif buttons.pressed(buttons.square) then
        Image.unload(square)
        Image.unload(circle)
        Image.unload(cross)
        choosing = false
        nextscene =  "assets/video/episode3/petra/choices/8/leverpetra_noreuben.lua"
