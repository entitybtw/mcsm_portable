...
local result = PMP.playEasy('assets/video/episode3/petra/choices/16/button.pmp', buttons.r, true, 'assets/subtitles/episode3/petra/choices/16/button.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    elseif buttons.pressed(buttons.circle) then
        choosing = false
        nextscene =  "assets/video/episode3/petra/choices/16/axel_button.lua"
    elseif buttons.pressed(buttons.cross) then
        choosing = false
        nextscene =  "assets/video/episode3/petra/choices/16/lukas_button.lua"
    elseif buttons.pressed(buttons.triangle) then
        choosing = false
        nextscene =  "assets/video/episode3/petra/choices/16/olivia_button.lua"
