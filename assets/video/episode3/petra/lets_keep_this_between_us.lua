...
local result = PMP.playEasy('assets/video/episode3/petra/lets_keep_this_between_us.pmp', buttons.r, true, 'assets/subtitles/episode3/petra/lets_keep_this_between_us.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
