...
local result = PMP.playEasy('assets/video/episode3/petra/we_have_to_tell_the_others.pmp', buttons.r, true, 'assets/subtitles/episode3/petra/we_have_to_tell_the_others.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
