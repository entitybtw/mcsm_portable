...
local result = PMP.playEasy('assets/video/episode3/no_gp/10/exit.pmp', buttons.r, true, 'assets/video/episode3/no_gp/10/exit.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
