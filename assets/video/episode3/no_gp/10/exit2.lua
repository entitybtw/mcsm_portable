...
local result = PMP.playEasy('assets/video/episode3/no_gp/10/exit_2.pmp', buttons.r, true, 'assets/subtitles/episode3/no_gp/10/exit_2.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
