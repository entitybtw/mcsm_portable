...
local choosing = true
local img = Image.load('assets/video/episode3/no_gp/11/help_me_save_the_world.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode3/no_gp/11/help_me_save_the_world.pmp', buttons.r)
