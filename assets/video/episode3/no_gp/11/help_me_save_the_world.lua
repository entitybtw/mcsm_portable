...
local result = PMP.playExt('assets/video/episode3/no_gp/11/help_me_save_the_world.pmp', buttons.r, true, 'assets/subtitles/episode3/no_gp/11/help_me_save_the_world.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
intraFont.print(45, 127, choices_three.i_guess_so, Color.new(255,255,255), font, 0.4)
intraFont.print(450 - intraFont.textW(font, choices_three.not_really, 0.4), 127, choices_three.not_really, Color.new(255,255,255), font, 0.4)
