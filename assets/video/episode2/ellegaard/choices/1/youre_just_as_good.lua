local choosing = true
local img = Image.load('assets/video/episode2/ellegaard/choices/1/youre_just_as_good.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode2/ellegaard/choices/1/youre_just_as_good.pmp', buttons.r)
