...
local result = PMP.playExt(
	"assets/video/episode2/ellegaard/choices/8/ellegaard_is_cool.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode2/ellegaard/choices/8/ellegaard_is_cool.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, choices_two.stay_out_of_it_axel, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_two.ellegaard_calm_down, 2),
	127,
