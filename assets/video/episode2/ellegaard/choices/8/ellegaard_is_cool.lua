...
local result = PMP.playEasy('assets/video/episode2/ellegaard/choices/8/ellegaard_is_cool.pmp', buttons.r, true, 'assets/video/episode2/ellegaard/choices/8/ellegaard_is_cool.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
