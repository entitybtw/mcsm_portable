...
local choosing = true
local img = Image.load('assets/video/episode2/ellegaard/choices/8/ellegaard_is_cool.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode2/ellegaard/choices/8/ellegaard_is_cool.pmp', buttons.r)
