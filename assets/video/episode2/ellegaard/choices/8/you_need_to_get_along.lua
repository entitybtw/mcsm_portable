...
local result = PMP.playExt('assets/video/episode2/ellegaard/choices/8/you_need_to_get_along.pmp', buttons.r, true, 'assets/subtitles/episode2/ellegaard/choices/8/you_need_to_get_along.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
