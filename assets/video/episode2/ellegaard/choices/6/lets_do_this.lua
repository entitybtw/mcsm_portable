...
local result = PMP.playEasy('assets/video/episode2/ellegaard/choices/6/lets_do_this.pmp', buttons.r, true, 'assets/video/episode2/ellegaard/choices/6/lets_do_this.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
