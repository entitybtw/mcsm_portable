...
local result = PMP.playEasy('assets/video/episode2/ellegaard/choices/2/intellectual.pmp', buttons.r, true, 'assets/video/episode2/ellegaard/choices/2/intellectual.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
while choosing do
    ...
    if buttons.pressed(buttons.square) then
        ...
        Image.unload(cross)
        choosing = false
        nextscene =  "assets/video/episode2/ellegaard/choices/2/chest_intellectual.lua"
    ...
    elseif buttons.pressed(buttons.cross) then
        ...
        Image.unload(cross)
        choosing = false
        nextscene =   "assets/video/episode2/ellegaard/choices/2/autofarm_intellectual.lua"
