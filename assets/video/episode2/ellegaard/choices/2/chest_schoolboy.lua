...
local result = PMP.playEasy('assets/video/episode2/ellegaard/choices/2/chest_fight.pmp', buttons.r, true, 'assets/video/episode2/ellegaard/choices/2/chest_fight.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
