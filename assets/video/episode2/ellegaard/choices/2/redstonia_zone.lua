...
while in_interactive_zone do
	...
	if not autofarm_used then
		...
		intraFont.print(
			125 - intraFont.textW(font, choices_two.autofarm, 1.5) / 2 + 8,
			216 + 14,
	...
	if not intellectual_talk then
		...
		intraFont.print(
			344 - intraFont.textW(font, choices_two.intellectual, 1.5) / 2 + 8,
			167 + 14,
	...
	elseif not fight then
		...
		intraFont.print(
			383 - intraFont.textW(font, choices_two.schoolboy, 1.5) / 2 + 8,
			197 + 14,
	...
	elseif fight then
		...
		intraFont.print(
			404 - intraFont.textW(font, choices_two.steal_repeater, 1.5) / 2 + 8,
			161 + 14,
	...
	if not chest_used then
		...
		intraFont.print(
			160 - intraFont.textW(font, choices_four.chest, 1.5) / 2 + 8,
			173 + 14,
			choices_four.chest,
			Color.new(255, 255, 255),
			font,
	...
	elseif autofarm_used and chest_used then
		...
		intraFont.print(
			241 - intraFont.textW(font, choices_two.crafting_table, 1.5) / 2 + 8,
			210 + 14,
