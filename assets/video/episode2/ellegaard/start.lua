...
local img
if bf == "bow" then
    nextscene = "assets/video/episode2/ellegaard/start.pmp"
    img = Image.load("assets/video/episode2/ellegaard/start_withbow.png")
elseif bf == "fishing_pole" then
    nextscene = "assets/video/episode2/ellegaard/start.pmp"
    img = Image.load("assets/video/episode2/ellegaard/start_withfishingpole.png")
else
    LUA.quit()
end
