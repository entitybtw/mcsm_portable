...
intraFont.print(45, 127, choices_two.youre_just_as_good, Color.new(255, 255, 255), font, 0.4)
intraFont.print(
	450 - intraFont.textW(font, choices_two.they_could_teach_you, 0.4),
	127,
	choices_two.they_could_teach_you,
