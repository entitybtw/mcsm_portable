...
local result = PMP.playEasy('assets/video/episode2/ellegaard_gabriel/4/hes_awesome.pmp', buttons.r, true, 'assets/subtitles/episode2/ellegaard_gabriel/4/hes_awesome.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
