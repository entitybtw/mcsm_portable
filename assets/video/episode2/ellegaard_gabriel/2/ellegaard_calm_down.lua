...
local result = PMP.playEasy('assets/video/episode2/ellegaard_gabriel/2/ellegaard_calm_down.pmp', buttons.r, true, 'assets/subtitles/episode2/ellegaard_gabriel/2/ellegaard_calm_down.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
