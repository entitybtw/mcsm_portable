...
local result = PMP.playEasy('assets/video/episode2/magnus_petra/pink_wool/hello_boom_town.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus_petra/pink_wool/hello_boom_town.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
