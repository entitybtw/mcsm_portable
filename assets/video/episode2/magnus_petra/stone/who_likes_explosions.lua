...
local result = PMP.playEasy('assets/video/episode2/magnus_petra/stone/who_likes_explosions.pmp', buttons.r, true, 'assets/video/episode2/magnus_petra/stone/who_likes_explosions.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
