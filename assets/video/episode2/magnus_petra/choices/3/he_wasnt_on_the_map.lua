...
local result = PMP.playExt('assets/video/episode2/magnus_petra/choices/3/he_wasnt_on_the_map.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus_petra/choices/3/he_wasnt_on_the_map.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
