...
local result = PMP.playExt('assets/video/episode2/magnus/fishing_pole.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/fishing_pole.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
intraFont.print(450 - intraFont.textW(font, choices_second.only_the_green_part, 0.4), 127, choices_second.only_the_green_part, Color.new(255,255,255), font, 0.4)
