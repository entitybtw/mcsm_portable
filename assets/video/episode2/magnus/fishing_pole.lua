...
local result = PMP.playEasy('assets/video/episode2/magnus/fishing_pole.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/fishing_pole.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
