...
local result = PMP.playExt('assets/video/episode2/magnus/choices/7/stone/2/who_likes_explosions.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/choices/7/stone/2/who_likes_explosions.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
