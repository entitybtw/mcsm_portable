...
local result = PMP.playExt('assets/video/episode2/magnus/choices/7/stone/1/youre_going_down.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/choices/7/stone/1/youre_going_down.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
