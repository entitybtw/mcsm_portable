...
local choosing = true
local img = Image.load('assets/video/episode2/magnus/choices/7/stone/1/what_about_the_plan.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode2/magnus/choices/7/stone/1/what_about_the_plan.pmp', buttons.r)
