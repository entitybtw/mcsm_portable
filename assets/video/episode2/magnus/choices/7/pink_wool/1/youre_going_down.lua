...
local choosing = true
local img = Image.load('assets/video/episode2/magnus/choices/7/pink_wool/1/youre_going_down.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode2/magnus/choices/7/pink_wool/1/youre_going_down.pmp', buttons.r)
