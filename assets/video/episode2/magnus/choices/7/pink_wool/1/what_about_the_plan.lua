...
local result = PMP.playExt(
	"assets/video/episode2/magnus/choices/7/pink_wool/1/what_about_the_plan.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode2/magnus/choices/7/pink_wool/1/what_about_the_plan.srt",
	font,
	subssize,
	"#FFFFFF",
	"#000000/150",
...
intraFont.print(
	450 - intraFont.textW(font, choices_second.who_likes_explosions, 0.4),
	127,
	choices_second.who_likes_explosions,
