...
local result = PMP.playExt('assets/video/episode2/magnus/choices/7/pink_wool/1/what_about_the_plan.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/choices/7/pink_wool/1/what_about_the_plan.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
...
intraFont.print(45, 127, choices_second.hello_boom_town, Color.new(255,255,255), font, 0.4)
intraFont.print(450 - intraFont.textW(font, "Who likes explosions?", 0.4), 127, "Who likes explosions?", Color.new(255,255,255), font, 0.4)
