...
intraFont.print(45, 127, choices_two.hello_boom_town, Color.new(255, 255, 255), font, 0.4)
intraFont.print(
	450 - intraFont.textW(font, choices_two.who_likes_explosions, 0.4),
	127,
	choices_two.who_likes_explosions,
