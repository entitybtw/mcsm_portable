...
local result = PMP.playExt('assets/video/episode2/magnus/choices/7/pink_wool/2/hello_boom_town.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/choices/7/pink_wool/2/hello_boom_town.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
