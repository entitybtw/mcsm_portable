...
local result = PMP.playEasy('assets/video/episode2/magnus/choices/5/you_dont_trust_me.pmp', buttons.r, true, 'assets/video/episode2/magnus/choices/5/you_dont_trust_me.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
