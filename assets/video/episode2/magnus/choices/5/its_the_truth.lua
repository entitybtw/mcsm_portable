...
local result = PMP.playEasy('assets/video/episode2/magnus/choices/5/its_the_truth.pmp', buttons.r, true, 'assets/video/episode2/magnus/choices/5/its_the_truth.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
