...
local result = PMP.playEasy('assets/video/episode2/magnus/choices/4/were_not_griefers.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/choices/4/were_not_griefers.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
