...
local result = PMP.playEasy('assets/video/episode2/magnus/choices/4/we_need_your_help.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/choices/4/we_need_your_help.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
