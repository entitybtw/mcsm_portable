...
intraFont.print(45, 127, choices_two.magnus_calm_down, Color.new(255, 255, 255), font, 0.4)
intraFont.print(
	450 - intraFont.textW(font, choices_two.stay_out_of_it_olivia, 0.4),
	127,
	choices_two.stay_out_of_it_olivia,
