...
local result = PMP.playExt(
	"assets/video/episode2/magnus/choices/9/you_need_to_get_along.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode2/magnus/choices/9/you_need_to_get_along.srt",
	font,
	subssize,
	"#FFFFFF",
	"#000000/150",
...
intraFont.print(45, 127, choices_second.magnus_calm_down, Color.new(255, 255, 255), font, 0.4)
intraFont.print(
	450 - intraFont.textW(font, choices_second.stay_out_of_it_olivia, 0.4),
	127,
	choices_second.stay_out_of_it_olivia,
