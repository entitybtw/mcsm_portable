...
local choosing = true
local img = Image.load('assets/video/episode2/magnus/choices/9/you_need_to_get_along.png')

PMP.setVolume(pmpvolume)
PMP.play('assets/video/episode2/magnus/choices/9/you_need_to_get_along.pmp', buttons.r)
