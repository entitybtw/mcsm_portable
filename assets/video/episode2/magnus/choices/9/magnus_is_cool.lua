...
local result = PMP.playEasy('assets/video/episode2/magnus/choices/9/magnus_is_cool.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/choices/9/magnus_is_cool.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
