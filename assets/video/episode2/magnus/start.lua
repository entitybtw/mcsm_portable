...
if bf == "bow" then
	...
	intraFont.print(45, 127, choices_two.bow, Color.new(255, 255, 255), font, 2)
elseif bf == "fishing_pole" then
	text = choices_two.fishing_pole
	intraFont.print(45, 127, choices_two.fishing_pole, Color.new(255, 255, 255), font, 2)
else
	LUA.quit()
end
PMP.setVolume(pmpvolume)
local result = PMP.playExt(
	"assets/video/episode2/magnus/start.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode2/magnus/start.srt",
	subs_font,
	subssize,
	"#FFFFFF",
	"#000000/110",
...
intraFont.print(45, 127, text, Color.new(255, 255, 255), font, 2)
intraFont.print(
	450 - intraFont.textW(font, choices_two.sword, 2),
	127,
	choices_two.sword,
