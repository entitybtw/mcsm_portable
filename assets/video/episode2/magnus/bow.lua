...
local result = PMP.playEasy('assets/video/episode2/magnus/bow.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/bow.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
