...
local result = PMP.playExt('assets/video/episode2/magnus/sword.pmp', buttons.r, true, 'assets/subtitles/episode2/magnus/sword.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
