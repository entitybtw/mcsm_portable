...
local result = PMP.playExt(
	"assets/video/episode2/magnus/sword.pmp",
	buttons.r,
	true,
	"assets/subtitles/episode2/magnus/sword.srt",
	font,
	subssize,
	"#FFFFFF",
	"#000000/150",
...
intraFont.print(45, 127, choices_two.i_know_what_this_means, Color.new(255, 255, 255), font, 0.4)
intraFont.print(
	450 - intraFont.textW(font, choices_two.only_the_green_part, 0.4),
	127,
	choices_two.only_the_green_part,
