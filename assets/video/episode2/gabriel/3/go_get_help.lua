...
local result = PMP.playExt('assets/video/episode2/gabriel/3/go_get_help.pmp', buttons.r, true, 'assets/subtitles/episode2/gabriel/3/go_get_help.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
