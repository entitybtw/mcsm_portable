...
local result = PMP.playEasy('assets/video/episode2/ellegaard_petra/theres_no_time.pmp', buttons.r, true, 'assets/video/episode2/ellegaard_petra/theres_no_time.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
