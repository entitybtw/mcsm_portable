...
local result = PMP.playEasy('assets/video/episode2/ellegaard_petra/choices/2/stay_out_of_it_axel.pmp', buttons.r, true, 'assets/subtitles/episode2/ellegaard_petra/choices/2/stay_out_of_it_axel.srt', font, subssize, "#FFFFFF", "#000000/150", subs)
if result == 1 then
