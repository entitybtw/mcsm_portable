...
while true do
    ...
    intraFont.printShadowed(280 - intraFont.textW(font, ui.pause_menu, 0.3) / 2 + 8, 193 + 14, ui.pause_menu, Color.new(255,255,255, imgfade), Color.new(0, 0, 0, imgfade), font, 90, 1, 0.3, 0)
