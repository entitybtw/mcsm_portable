...
while true do
	...
	if isFadingOut then
		...
		if imgfade > 0 then
			imgfade = math.max(imgfade - 8, 0)
		end
		if creditfade > 0 then
			creditfade = math.max(creditfade - 5, 0)
		end
	...
	intraFont.printShadowed(
		225 - intraFont.textW(font, ui.controls, 0.2) / 2 + 8,
		5 + 14,
		ui.controls,
		Color.new(255, 255, 255, imgfade),
		Color.new(0, 0, 0, imgfade),
	...
	intraFont.printShadowed(
		...
		259,
		ui.art_by,
		Color.new(255, 255, 255, creditfade),
		Color.new(0, 0, 0, creditfade),
		font,
		90,
		1,
		0.3,
