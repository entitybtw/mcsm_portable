...
while true do
	...
	if buttons.pressed(buttons["square"]) then
		...
		if curEp == 1 then -- if the 1st episode is selected and the square button is pressed, a question appears about deleting key saves or regular saves
			System.message(
				"Do you want to delete the save files for episode 1, or just the key save files? Save files - Yes, Key save files - No",
				1
			) -- if you clicking yes, opens usual saves management menu, if you click no, all key saves are being deleted, if you click back it returns to episode menu
		...
		elseif curEp == 3 then -- if the 1st episode is selected and the square button is pressed, a question appears about deleting key saves or regular saves
			System.message(
				"Do you want to delete the save files for episode 3, or just the key save files? Save files - Yes, Key save files - No",
				1
			) -- if you clicking yes, opens usual saves management menu, if you click no, all key saves are being deleted, if you click back it returns to episode menu
			local answer = System.buttonPressed()
			if answer == "Yes" then
