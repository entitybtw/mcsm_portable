choices_one = {
	...
	cool_mask = "Cool Mask",
	not_funny_axel = "Not funny, Axel",

	gabriel_is_awesome = "Gabriel is awesome",
	no_big_deal = "No big deal",

	build_a_creeper = "Build a Creeper",
	build_a_enderman = "Build an Enderman",

	dead_enders = "Dead Enders",
	nether_maniacs = "Nether Maniacs",
	...
	run_i_distract_them = "Run, I'll distract them!",
	stay_close_i_protect_you = "Stay close, I'll protect you",

	im_all_in = "I'm all in",
	whats_in_it_for_me = "What's in it for me?",

	lever = "Craft a lever!",
	stone_sword = "Craft a stone sword!",
	...
	got_a_bad_feeling = "Got a bad feeling",
	im_cool_if_he_is = "I'm cool if he is",

	your_friend_hurt_my_pig = "Your friend hurt my pig",
	your_machine_was_cool = "Your machine was cool",

	offer_sword = "Offer sword",
	threaten = "Threaten",

	chicken_machine = "Chicken Machine",
	crafting_table = "Crafting Table",
	lukas = "Lukas",
	slime = "Slime",

	we_ask_politely = "We ask politely",
	we_get_payback = "We get payback",

	its_all_yours = "It's all yours",
	leave_it_alone = "Leave it alone",

	stay_quiet = "Stay quiet",
	warn_olivia = "Warn olivia",

	im_going_after_lukas = "I'm going after lukas",
	lets_talk_to_gabriel = "Let's talk to gabriel",

	run_for_it = "Run for it",
	sit_tight = "Sit tight",

	somebody_stop_him = "Somebody stop him",
	this_cant_be_good = "This can't be good",

	he_cant_stop_it = "He can't stop it",
	what_are_you_doing = "What are you doing",

	follow_gabriel = "Follow Gabriel",
	help_lukas = "Help Lukas",

	but_why_me = "But why me",
	where_are_they = "Where are they",

	save_gabriel = "Save Gabriel",
	save_petra = "Save Petra",

	its_your_fault = "It's your fault",
	petra_will_make_it = "Petra will make it",

	hands_in_the_air = "Hands in the air",
	hold_on_tight = "Hold on tight",

	it_was_fine = "It was fine",
	yeah_its_awful = "Yeah, it's awful",

	i_go_first = "I go first",
	you_can_do_it = "You can do it",

	build_a_dirt_hut = "Build a dirt hut",
	build_a_treehouse = "Build a treehouse",

	give_cookie = "Give cookie",
	keep_cookie = "Keep cookie",

	stay_here = "Stay here",
	you_should_go = "You should go",

	all_is_good = "All is good",
	keep_your_distance = "Keep your distance",

	craft_a_bow = "Craft a bow",
	craft_a_fishing_pole = "Craft a fishing pole",

	ivor_isnt_a_hero = "Ivor isn't a hero",
	this_explains_a_lot = "This explains a lot",
...
choices_four = {
	...
	give_her_some_space = "Give her some space",
	give_him_some_space = "Give him some space",
	she_doesnt_know_us = "She doesn't know us",
	he_forgot_everyone = "He forgot everyone",

	go_talk_to_gabriel = "Go talk to Gabriel",
	go_talk_to_petra = "Go talk to Petra",
	stay_with_petra = "Stay with Petra",
	stay_with_gabriel = "Stay with Gabriel",

	just_have_our_back = "Just have our back",
	youll_get_a_chance = "You'll get a chance",
	doesnt_matter_now = "Doesn't matter now",
	we_all_make_mistakes = "We all make mistakes",
	i_chose_gabriel = "I chose Gabriel",
	i_couldnt_save_you = "I couldn't save you",
	its_ivors_fault = "It's Ivor's fault",
	you_didnt_know = "You didn't know",

	nothing_you_can_do = "Nothing you can do",
	they_could_be_alive = "They could be alive",

	the_order_has_failed = "The Order has failed",
	the_world_needs_us = "The world needs us",

	let_it_chase_us = "Let it chase us",
	use_the_amulet = "Use the amulet",

	redstone_rap = "Redstone Rap",
	warrior_whip = "Warrior Whip",

	are_we_there_yet = "Are we there yet",
	we_must_be_close = "We must be close",

	lets_head_back = "Let's head back",
	we_need_that_cake = "We need that cake",

	get_ready_to_fight = "Get ready to fight",
	ill_distract_them = "I'll distract them",
	he_bailed_on_me = "He bailed on me",
	i_have_no_idea = "I have no idea",

	find_another_way = "Find another way",
	lets_go_inside = "Let's go inside",

	we_have_to_continue = "We have to continue",
	were_back_together = "We're back together",

	we_reunited_the_order = "We reunited the Order",
	we_won_at_endercon = "We won at Endercon",

	craft_redstone_block = "Craft redstone block",
	craft_sticky_piston = "Craft sticky piston",

	that_was_endercon = "That was Endercon",
	the_chicken_machine = "The chicken machine",
	...
	i_wont_lie_to_you = "I won't lie to you",
	youll_be_fine = "You'll be fine",

	are_those_ender_crystals = "Are those ender crystals",
	is_the_dragon_a_clue = "Is the dragon a clue",

	that_was_amazing = "That was amazing",
	youre_full_of_it = "You're full of it",

	i_looked_up_to_you = "I looked up to you",
	you_lied_to_everyone = "You lied to everyone",

	how_is_this_better = "How is this better",
	youre_a_mad_man = "You're a mad man",

	craft_diamond_hoe = "Craft diamond hoe",
	craft_diamond_pickaxe = "Craft diamond pickaxe",

	fight_to_the_death = "Fight to the death",
	i_made_a_weapon = "I made a weapon",

	come_back = "Come back",
	you_coward = "You coward",

	flying_machine = "Flying machine",
	rocket_minecart = "Rocket minecart",
	tnt_launcher = "TNT launcher",

	ill_be_fine = "I'll be fine",
	stay_hidden = "Stay hidden",

	everyone_okay = "Everyone okay",
	wheres_reuben = "Where's Reuben",

	im_here_for_you_boy = "I'm here for you, boy",
	reuben_i_need_you = "Reuben, I need you",

	just_let_them_believe = "Just let them believe",
	they_deserve_the_truth = "They deserve the truth",
